...
func (s *testParserSuite) TestSimple(c *C) {
	...
	// Fix: https://github.com/daiguadaidai/m-sql-review/dependency/issues/971
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	...
	table := []testCase{
		...
		// for https://github.com/daiguadaidai/m-sql-review/dependency/issues/320
		{`(select 1);`, true},

		// for https://github.com/daiguadaidai/m-sql-review/dependency/issues/1050
