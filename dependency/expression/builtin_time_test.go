...
func (s *testEvaluatorSuite) TestDateFormat(c *C) {
	...
	// Test case for https://github.com/daiguadaidai/m-sql-review/dependency/issues/2908
...
func (s *testEvaluatorSuite) TestUnixTimestamp(c *C) {
	...
	// https://github.com/daiguadaidai/m-sql-review/dependency/issues/2496
	...
	// https://github.com/daiguadaidai/m-sql-review/dependency/issues/2852
