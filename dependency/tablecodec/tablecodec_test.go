...
func (s *testTableCodecSuite) TestDecodeBadDecical(c *C) {
	gofail.Enable("github.com/daiguadaidai/m-sql-review/dependency/util/codec/errorInDecodeDecimal", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/m-sql-review/dependency/util/codec/errorInDecodeDecimal")
